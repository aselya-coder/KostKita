...
BEGIN
  ...
  VALUES 
    (v_kos_id, 'f0c1db18-3150-4869-a62c-2c4faedc0d43', 'Kos Harmoni Residence', 'Jl. Margonda Raya, Depok (Dekat UI)', 1500000, ARRAY['https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?w=600&q=80', 'https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?w=600&q=80'], ARRAY['WiFi', 'AC', 'Kamar Mandi Dalam', 'Parkir'], 4.8, true, 'Kos nyaman sangat dekat dengan kampus UI Depok dengan fasilitas lengkap. Lingkungan aman dan tenang, cocok untuk mahasiswa.', ARRAY['Tidak boleh membawa hewan', 'Jam malam 23:00', 'Tidak merokok di dalam kamar'], 'campur', 3, 'approved'),
    (uuid_generate_v4(), 'f0c1db18-3150-4869-a62c-2c4faedc0d43', 'Kos Putri Melati', 'Jl. Kaliurang KM 5, Yogyakarta (Dekat UGM)', 900000, ARRAY['https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?w=600&q=80', 'https://images.unsplash.com/photo-1486304873000-235643847519?w=600&q=80'], ARRAY['WiFi', 'Kamar Mandi Dalam', 'Dapur Bersama'], 4.5, false, 'Kos putri bersih dan nyaman sangat dekat dengan kampus UGM. Akses mudah ke kampus dan pusat kota.', ARRAY['Khusus putri', 'Jam malam 22:00', 'Tamu lawan jenis di ruang tamu saja'], 'putri', 2, 'approved'),
    (uuid_generate_v4(), 'f0c1db18-3150-4869-a62c-2c4faedc0d43', 'Kos Eksekutif Sudirman', 'Jl. Sudirman No. 45, Bandung (Dekat ITB)', 2200000, ARRAY['https://images.unsplash.com/photo-1493809842364-78817add7ffb?w=600&q=80', 'https://images.unsplash.com/photo-1484101403633-562f891dc89a?w=600&q=80'], ARRAY['WiFi', 'AC', 'Kamar Mandi Dalam', 'Parkir', 'Laundry', 'CCTV'], 4.9, true, 'Kos eksekutif full furnished sangat dekat dengan kampus ITB. Fasilitas premium dengan keamanan 24 jam.', ARRAY['Tidak boleh membawa hewan', 'Deposit 1 bulan'], 'campur', 1, 'approved'),
  ...
  VALUES 
    (uuid_generate_v4(), '5d3a8827-59f3-45b5-9bbb-7c094afc8721', 'Textbook Kalkulus Purcell Ed. 9', 75000, 'https://images.unsplash.com/photo-1544716278-ca5e3f4abd8c?w=400&q=80', 'Buku', 'Bekas - Baik', 'Yogyakarta (Dekat UGM)', 'Buku kalkulus Purcell edisi 9, ada sedikit coretan pensil tapi masih sangat layak. Bisa COD dekat kampus UGM.', 'active'),
    (uuid_generate_v4(), '5d3a8827-59f3-45b5-9bbb-7c094afc8721', 'Laptop ASUS VivoBook 14', 4500000, 'https://images.unsplash.com/photo-1496181133206-80ce9b88a853?w=400&q=80', 'Elektronik', 'Bekas - Sangat Baik', 'Yogyakarta (Dekat UGM/UNY)', 'Laptop ASUS VivoBook 14 inch, i5 Gen 10, RAM 8GB, SSD 512GB. Masih mulus. Bisa COD sekitar UGM atau UNY.', 'active'),
    (uuid_generate_v4(), '5d3a8827-59f3-45b5-9bbb-7c094afc8721', 'Sepeda Lipat Polygon', 2000000, 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&q=80', 'Kendaraan', 'Bekas - Baik', 'Bandung (Dekat ITB)', 'Sepeda lipat Polygon Urbano 3, cocok untuk mobilitas di sekitar kampus ITB atau Unpad Dipatiukur.', 'active'),
    (uuid_generate_v4(), '5d3a8827-59f3-45b5-9bbb-7c094afc8721', 'Meja Belajar Minimalis', 350000, 'https://images.unsplash.com/photo-1518455027359-f3f8164ba6bd?w=400&q=80', 'Furnitur', 'Bekas - Baik', 'Sumedang (Dekat Unpad Jatinangor)', 'Meja belajar minimalis kayu jati, ukuran 100x60cm. Ada laci kecil. Lokasi dekat Unpad Jatinangor / IPDN.', 'active'),
    (uuid_generate_v4(), '5d3a8827-59f3-45b5-9bbb-7c094afc8721', 'Kamus Oxford Advanced', 120000, 'https://images.unsplash.com/photo-1481627834876-b7833e8f5570?w=400&q=80', 'Buku', 'Bekas - Sangat Baik', 'Semarang (Dekat Undip)', 'Kamus Oxford Advanced Learner''s Dictionary edisi terbaru. Bisa COD area Undip Tembalang.', 'active'),
    (uuid_generate_v4(), '5d3a8827-59f3-45b5-9bbb-7c094afc8721', 'Rice Cooker Miyako 1.8L', 150000, 'https://images.unsplash.com/photo-1585664811087-47f65abbad64?w=400&q=80', 'Elektronik', 'Bekas - Baik', 'Yogyakarta (Dekat UNY)', 'Rice cooker Miyako 1.8L, fungsi normal semua. Cocok untuk anak kos. Lokasi dekat UNY.', 'active');
