  ...
  return (
    <div className="space-y-6 md:space-y-8 pb-12 px-4 md:px-0 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-xl md:text-2xl font-display font-bold text-foreground">Moderasi Marketplace</h1>
          <p className="text-muted-foreground text-xs md:text-sm">Pantau dan kelola semua barang yang dijual di marketplace.</p>
        </div>
      </div>
